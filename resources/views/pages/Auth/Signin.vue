<template>
    <main class="main-content  mt-0">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 m-3 border-radius-lg" style="background-image: url('public/img/curved-images/curved9.jpg');">
        <span class="mask bg-gradient-dark opacity-6"></span>
        <div class="container">
            <div class="row justify-content-center">
            <div class="col-lg-5 text-center mx-auto">
                <h1 class="text-white mb-2 mt-5">Signin</h1>
        ...
        <div class="row mt-lg-n10 mt-md-n11 mt-n10 justify-content-center">
            ...
            <div class="card z-index-0">
                ...
                <div class="card-body">
                <div class="alert alert-danger" v-if="errors.error">{{errors.error}}</div>
                <form @submit.prevent="submit" class="text-start">
                    ...
                    <div class="mb-3">
                    <input type="password" v-model="form.password" class="form-control" required placeholder="Password" aria-label="Password"  data-smk-msg="Please provide password">
                    ...
                    <button type="submit" :disabled="form.processing" class="btn bg-gradient-info w-100 my-4 mb-2">Sign in</button>
                    </div>
                    ...
                    <div class="text-center">
                        <Link href="/signup" class="btn bg-gradient-dark w-100 mt-2 mb-4">Sign up</Link>
                    </div>
                </form>
                </div>
            </div>
...
export default {
    ...
    methods:{
        submit(){
			Inertia.post('login-user', this.form)
