            ...
            <div class="row mb-5">
                ...
                <div class="card card-body" id="profile">
                    ...
                    <div class="col-sm-auto col-4">
                        ...
                        <img src="img/bruce-mars.jpg" alt="bruce" class="w-100 border-radius-lg shadow-sm">
                        </div>
                    </div>
                ...
                <div class="card mt-4" id="basic-info">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            <input id="firstName" name="firstName" v-model="user.firstname" class="form-control" type="text" placeholder="Alec" required="required">
                        </div>
                        </div>
                        <div class="col-6">
                        <label class="form-label">Last Name</label>
                        <div class="input-group">
                            <input id="lastName" name="lastName" v-model="user.lastname" class="form-control" type="text" placeholder="Thompson" required="required">
                        </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            <input id="email" name="email" v-model="user.email" class="form-control" type="email" placeholder="example@email.com" disabled>
                        </div>
                        </div>
                        <div class="col-6">
                ...
                <div class="card mt-4" id="accounts">
                    ...
                    <div class="card-body pt-0">
                    <div class="d-flex">
                        <img class="width-48-px" src="/img/small-logos/logo-slack.svg" alt="logo_slack">
                    ...
                    <hr class="horizontal dark">
                    <div class="d-flex">
                        <img class="width-48-px" src="/img/small-logos/logo-spotify.svg" alt="logo_spotify">
                        <div class="my-auto ms-3">
                        <div class="h-100">
                    ...
                    <hr class="horizontal dark">
                    <div class="d-flex">
                        <img class="width-48-px" src="/img/small-logos/logo-atlassian.svg" alt="logo_atlassian">
                        <div class="my-auto ms-3">
                        <div class="h-100">
                    ...
                    <hr class="horizontal dark">
                    <div class="d-flex">
                        <img class="width-48-px" src="/img/small-logos/logo-asana.svg" alt="logo_asana">
                        <div class="my-auto ms-3">
                        <div class="h-100">
...
<script >
import Sidebar from '../../layouts/SideNav.vue'
